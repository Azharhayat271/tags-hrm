-- Fixed Storage RLS Policies for salary-slips bucket
-- These policies work with storage.objects table
...
-- Checks if the first folder in the path matches their employee_id
